...
type Post struct {
	...
	Contents        []Content     `json:"contents,omitempty" bson:"-"`
	ContentsRef     []interface{} `json:"contents_ref,omitempty" bson:"contents_ref,omitempty"`
	...
	PostLocationRef interface{}   `json:"post_location_ref,omitempty" bson:"post_location_ref,omitempty"`
	PostCreator     User          `json:"post_creator,omitempty" bson:"post_creator,omitempty"`
	PostCreatorRef  interface{}   `json:"post_creator_ref,omitempty" bson:"post_creator_ref,omitempty"`
}
